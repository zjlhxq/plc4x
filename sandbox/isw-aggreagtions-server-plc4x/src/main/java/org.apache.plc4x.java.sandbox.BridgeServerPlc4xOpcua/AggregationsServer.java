...
public class AggregationsServer {

    private static final int TCP_BIND_PORT = 12687;
    private static final int HTTPS_BIND_PORT = 8444;
    ...
    private final AggregationsNamespace Namespace;
    private final Logger logger = LoggerFactory.getLogger(getClass());

    public AggregationsServer() throws Exception {
        ...
        Namespace = AggregationsNamespace.create(server);
        Namespace.startup();
    }

    public static void main(String[] args) throws Exception {
        AggregationsServer server = new AggregationsServer();
    ...
    private static EndpointConfiguration buildTcpEndpoint(EndpointConfiguration.Builder base) {
        ...
        //BrowseClient omg = new BrowseClient();
    }
    ...
    private Set<EndpointConfiguration> createEndpointConfigurations(X509Certificate certificate) {
        ...
        hostnames.add(HostnameUtil.getHostname()); //addet Felixs-MacBook-Air.local
        hostnames.addAll(HostnameUtil.getHostnames("0.0.0.0")); //addet localhost, 192.168.178.27, 127.0.0.1
        //hostnames.add("192.168.178.27");

        logger.info("Hier die Hostnames: {}", hostnames.toString());
    ...
    public AggregationsNamespace getNamespace() {
        return Namespace;
    }
