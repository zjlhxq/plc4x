...
[dataIo 'DataItem' [string '-1' 'dataProtocolId', int 32 'stringLength']
    [typeSwitch 'dataProtocolId'
        ...
        // -----------------------------------------
        ['IEC61131_CHAR' CHAR
            [manual string '-1' 'UTF-8' 'value'  'STATIC_CALL("org.apache.plc4x.java.s7.utils.StaticHelper.parseS7Char", readBuffer, _type.encoding)' 'STATIC_CALL("org.apache.plc4x.java.s7.utils.StaticHelper.serializeS7Char", writeBuffer, _value, _type.encoding)' '1 * 8']
        ]
        ['IEC61131_WCHAR' CHAR
